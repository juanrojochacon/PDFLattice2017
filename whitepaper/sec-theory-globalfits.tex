...
are not parametrized as in Eq.~(\ref{eq:pdffunc}), but rather they are
...
in~\cite{Forte:2013wc,Butterworth:2015oua,Accardi:2016ndt,Gao:2017yyd} 
...
of the perturbative expasion, is usually inferred by comparing NLO to NNLO 
...
was studied in~\cite{Binoth:2010nha,Thorne:2012az}, for unpolarized PDFs, 
...
Sects.~\ref{subsubsec:GPDFfits}-\ref{subsec:BN}.
