...
%\hline 
%\end{tabular}
%\caption{Benchmark values for lattice calculations of the zeroth moments of pol%arised PDFs. Results with a superscript $\dagger$ are from a single lattice cal%culation; these values may underestimate some sources of uncertainty.}
%\label{tab:LQCDpol0}
%\end{table}
%%------------------------------------------------------------------------------%-
%\begin{table}
...
%\hline 
%\end{tabular}
%\caption{Benchmark value for lattice calculations of the first moments of polar%ised PDFs.}
%\label{tab:LQCDpol1}
%\end{table}
