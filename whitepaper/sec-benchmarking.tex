...
Mellin  moments of unpolarized and polarized PDFs.
%
...
%
For each benchmark quantity, we specify the prescription adopted to 
...
flavor combinations, specifically:
\begin{itemize}
  \item
...
calculations of higher moments and/or of moments of other PDF 
...
\begin{itemize}
%
\item[\bstar] Non-perturbative renormalisation.
%
...
the  one associated to the propagated of the
experimental errors from the fitted cross-sections,
the one associated with incompatibility of the 
fitted experiments, and procedural uncertainties such as those related to the choice
functional form of PDFs and the handling of systematic errors, among others.
%
...
%
All values shown here are at $\mu^2=Q^2=4$ GeV$^2$.
%
...
%
The value of $g_A$ is scale independent, and we quote all other results at $\mu^2=Q^2=4$ GeV$^2$.
%
