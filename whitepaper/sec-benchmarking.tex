...
%
It is now recognized that PDF uncertainties receives various contributions: 
...
CJ15 and ABMP16 PDF sets, which is otherwise excluded from the PDF4LHC set.
...
the right panel of Fig.~\ref{fig:Bmomspol} in the same format as in 
Fig.~\ref{fig:Bmomsunp}.
