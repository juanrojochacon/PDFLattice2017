...
Our criteria and the corresponding ratings are chosen to provide as 
...
%
We emphasize that a consensus is reached in adopting a rating system that 
takes into account the current state of lattice QCD calculations. 
%
Modifications to this rating system will naturally occur as the lattice-QCD 
results evolve.
...
results in Tables~\ref{tab:gAstatus}--%\ref{tab:polLQCDstatus0}--\ref{tab:polLQCDstatus1}--
\ref{tab:polPDFmoms}
