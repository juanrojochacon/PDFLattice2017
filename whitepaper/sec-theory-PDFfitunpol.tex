...
As a representative illustration of how the results of a typical global
PDF analysis look like, in Fig.~\ref{fig:nnlopdfs} we show
the results of the NNPDF3.1 NNLO fit both  a low scale
    ...
    PDF uncertainties, as discussed below.
...
It is important to emphasize that there are additional sources of theoretical
...
QCD results that represent an ``all-order'' computation.
