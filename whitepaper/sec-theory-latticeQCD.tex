...
%\Blue{(JWC: Choosing $\alpha = 4$ drops a term that is purely higher-twist, but the remaining term still has higher-twist effect. This can be seen easily from OPE.)}
...
%\Red{(JWC: Apparently Fig.~\ref{fig:matched} does not appear in Ref.~\cite{Alexa%ndrou:2017huk}. It should be explained whether Fig.~\ref{fig:matched} is obtained from the Fourier transform of the renormalized $\Delta h(z)$ without the $p_z$ corrections.)}
%
