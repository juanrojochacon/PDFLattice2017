...
Figure~\ref{fig:qPDF-demo} shows example results for the renormalized unpolarized PDF from Ref.~\cite{Chen:2017mzz} and helicity PDF from Ref.~\cite{Alexandrou:2017huk}.
...
(Left)LP3's renormalized unpolarized isovector quark distribution at pion mass of 310 MeV after one-loop matching and mass correction at the renormalization scale $\mu=2$~GeV~\cite{Chen:2017mzz}. %The red band shows the extrapolation to infinite momentum. \\
(Right) ETMC's renormalized helicity PDF at pion mass of 375 MeV~\cite{Alexandrou:2017huk} . 
%Comparison of matched helicity PDF obtained from quasi-PDF computed with either fully renormalized matrix elements (blue) 
