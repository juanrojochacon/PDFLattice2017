...
Luigi~del~Debbio$^{19}$, 
Michael~Engelhardt$^{20}$, 
Jeremy~Green$^{21}$, 
Rajan~Gupta$^{22}$, 
Lucian~Harland-Lang$^{23}$, 
Tomomi~Ishikawa$^{24}$, 
Aleksander~Kusina$^{25}$, 
Keh-Fei~Liu$^{26}$, 	
Simonetta~Liuti$^{27}$, 		
Christopher~Monahan$^{28}$, 		
Pavel~Nadolsky$^{3}$, 
Ingo~Schienbein$^{29}$, 	
Gerrit~Schierholz$^{30}$, and
Werner~Vogelsang$^{31}$
}
...
~$^{20}$ Department of Physics, New Mexico State University, Las Cruces, NM 88003-8001, USA. \\
~$^{21}$ NIC, Deutsches Elektronen-Synchrotron, 15738 Zeuthen, Germany.\\
~$^{22}$ Los Alamos National Laboratory, Theoretical Division, T-2, Los Alamos, NM 87545, USA. \\
~$^{23}$ UCL \\
~$^{24}$ T.~D.~Lee Institute, Shanghai Jiao Tong University, Shanghai, 200240, P.~R.~China. \\
~$^{25}$ LPSC Grenoble \\
~$^{26}$ Department of Physics and Astronomy, University of Kentucky, Lexington, KY 40506, USA. \\
~$^{27}$ Virginia \\
~$^{28}$ Institute for Nuclear Theory, University of Washington, Seattle, WA 98195, USA. \\
~$^{29}$ LPSC Grenoble \\
~$^{30}$ Deutsches Elektronen-Synchrotron DESY, 22603 Hamburg, Germany. \\
~$^{31}$ Tuebingen \\
}
