...
research field with phenomenological implications for
...
%
Two main approaches exist to determine the proton PDFs.
%
The first one is the global QCD analysis, based on the 
factorisation of hard-scattering cross-sections into perturbative
short-distance
matrix elements and the PDFs representing non-perturbative  long-distance dynamics,
where the latter are constrained by
experimental data from lepton-proton and proton-proton
collisions.
%
...
lattice-QCD calculations of the proton structure.
%
...
establishing a common language between the two communities, in order to 
maximise and foster mutual interactions 
to further improve our knowledge of the partonic structure of nucleons.
