...
high energy physics, nuclear and astroparticle physics.
%
There exist two main approaches to determine the
Parton Distribution Functions (PDFs) of the proton that
quantify how its momentum and the spin 
is divided among its quark and gluon constituents.
%
The first is the global QCD analysis, which exploits that fact that hard-scattering
...
PDFs.
%
The second approach is based on the non-perturbative
 computation of PDFs
...
to the proton structure, in this white-paper we present a systematic
overview of the lattice QCD calculations of PDF-related quantities, as
well as of their
state-of-the-art evaluation from global analysis.
%
Following a review of progress in global QCD fits and lattice
QCD calculations, we present benchmark quantities that can
