...
%
The first approach, based on QCD factorization theorems, uses a global 
analysis of a suitable set of experimental measurements, possibly from 
a variety of hard-scattering processes.
%
...
%The detailed understanding of the internal structure of nucleons is an 
%active research field with phenomenological implications for
%high-energy, nuclear, and astroparticle physics.
%%
%Within Quantum Chromodynamics (QCD), this internal structure
%is encoded by the parton distribution functions (PDFs), which
%quantify how the  momentum and spin of the nucleon
%are divided among its quark and gluon constituents.
%%
%Two main approaches exist to determine PDFs.
%%
%The first one is the global QCD analysis, based on the 
%factorisation of hard-scattering cross-sections into perturbative
%short-distance
%matrix elements and the PDFs representing non-perturbative  long-distance 
%dynamics, where the latter are constrained by
%experimental data from hard-scattering processes.
%%
%The second approach is based on the direct calculation of PDFs
%and their moments from their first-principles operator
%definitions using lattice-QCD.
%%
%Motivated by recent progress in both approaches,
%here we present a systematic
%overview of lattice-QCD calculations of PDF-related quantities, together with
%their state-of-the-art evaluation from global analysis.
%%
%Following a review of the latest
%developments, we provide benchmark quantities suitable
%to validate present and future
%lattice-QCD calculations of proton structure.
%%
%We then illustrate how lattice-QCD calculations could be used
%to reduce the PDF uncertainties
%in unpolarised and polarised global analyses.
%%
%This white paper represents a first step towards
%establishing a common language between the two communities, to 
%foster dialogue and
%further improve our knowledge of the partonic structure of nucleons.
