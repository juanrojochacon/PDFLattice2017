...
deep-inelastic lepton scattering, as well as polarized $pp$ scattering. 
%
...
\,\mbox{,}
\ \ \ \ \ \ \ \ \ \
f=u,\bar{u},d,\bar{d},s,\bar{s},c,\bar{c},\ldots,g
\,\mbox{.}
\label{eq:polPDFs}
\end{equation}
%
Much of the interest in the $\Delta f$ originates from the fact that their 
...
%
In particular, the first moments of the singlet and the gluon polarised PDFs,
\begin{align}
\Delta\Sigma(\mu^2)
& =
...
As in the unpolarised case, the dependence of the helicity PDFs on the 
scale $\mu$ can be computed perturbatively by means of DGLAP evolution 
equations, Eq.~(\ref{eq:dglap}).
%
